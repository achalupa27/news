...
const fetchNews = async (category?: Category | string, keywords?: string, isDynamic?: boolean) => {
    ...
    const res = await fetch('https://ovruch.stepzen.net/api/newsdemo/__graphql', {
        method: 'POST',
...
//stepzen import curl "http://api.mediastack.com/v1/news?access_key=c2ae1fa58042fde0013510738b4fb59e&sources=business,sports"
